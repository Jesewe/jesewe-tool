...
class tiktok:
    ...
    def update_title(self):
        ctypes.windll.kernel32.SetConsoleTitleW(f"TikTok Share Botter | Sent Shares: {self.shared} | Errors: {self.errors}")
    ...
    def main(self):
        os.system(clear)
        if clear == "cls":
            ctypes.windll.kernel32.SetConsoleTitleW(f"TikTok Share Botter")
